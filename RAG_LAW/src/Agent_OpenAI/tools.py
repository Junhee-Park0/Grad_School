...
from src.Agent_OpenAI.schemas import (UserInput, InputDocument, QueryAnswerable,
...
from src.Agent_OpenAI.functions import load_prompt, document_ocr, truncate_context_texts
...
def rerank_contexts(combined_queries: QueryList, all_contexts: ContextList) -> ContextList:
    ...
    try:
        ...
        web_results_org = [context for context in all_contexts.list_contexts if context.doc_type == "External_Web"]
        ...
        if web_results_org:
            ...
            truncated_contexts = []
            for context in web_results_org:
